...
urlpatterns = [
    ...
    # les chemins pour acceder aux documents en fonction des génies
    ...
    #les chemins concernant les commentaires
    ...
    # les urls de récupération de mot de passe oublié
